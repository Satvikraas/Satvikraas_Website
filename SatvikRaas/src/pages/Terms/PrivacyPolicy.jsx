  ...
  return (
     <div className={styles.mainPage}>
          ...
          <div className={styles.section1}>
            <h2>What do we do with your Informationl ?</h2>
            <p>When you purchase something from our store, as part of the buying and selling process, we collect the personal information you give us such as your name, address and email address.<br /><br />
...
If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at Satvikraas@gmail.com / Customercare@satvikraas.com or mailing us at: S NO-573/7, PLOT NO-662/11, OFFICE NO-104, 1ST FLR, HOTEL SAPNA, ABOVE SHAHI BHOJ RESTAURANT, JANGALI MAHARAJ ROAD, SHIVAJINAGAR, Pune, Maharashtra-411005 Office Address
...
Links : When you click on links on our store, they may direct you away from our site. We are not responsible for the privacy practices of other sites and encourage you to read their privacy statements.
          ...
          </div>  <div className={styles.section1}>
            <h2>Questions and Contact Information</h2>
            <p>

            If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at customercare@satvikraas.com or by mail at <span>S NO-573/7, PLOT NO-662/11, OFFICE NO-104, 1ST FLR, HOTEL SAPNA, ABOVE SHAHI BHOJ RESTAURANT, JANGALI MAHARAJ ROAD, SHIVAJINAGAR, Pune, Maharashtra-411005 </span>
            <br /><br />
