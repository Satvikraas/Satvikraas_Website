    ...
    <div className="product-container">
      ...
      <div className="product-row">
        <div className="product-info">
          ...
          <div className="product-details">
            ...
            <div className="variant-dropdown">
              {" "}
              Quantity :{productVariantDTO?.weight}
            </div>
          </div>
        </div>

        <div className="quantity-txt ">{cartItemQuantity}</div>
        ...
        <div className="actions-container">
          <div className="actions-group">
            ...
            <div className="quantity-controls">
              ...
              <button
                disabled={isSingleProduct}
                className="quantity-button"
                onClick={addCartItemQuantityChange}
              >
                +
              </button>
            </div>
          ...
          <div className="price">
            ₹ {productVariantDTO.price * cartItemQuantity}
          </div>
        </div>
      </div>
    </div>
