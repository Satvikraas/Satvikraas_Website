  ...
  return (
    <div className="checkout-container">
      ...
      <div className="progress-steps">
        <div className={`step ${currentStep === 'products' ? 'active' : ''}} onClick={() => setCurrentStep('products')`}>
          <div className="step-icon icon-package"></div>
          <span>Ordered Products</span>
        </div>

        <div className={`step ${currentStep === 'address' ? 'active' : ''}} onClick={items && items.length > 0 ? () => setCurrentStep('address') : undefined`}>
      ...
      {currentStep === 'products' && (
        ...
        <CartItemRow key={i} cartItem={cartItem} updateQuantity={updateQuantity} removeItem={removeItem} />
          ...
          <div className="text-right">
            <p className="price-info">Subtotal:<span> ₹{subtotal}</span></p>
            ...
            <input
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  else{setIsAddressServiceable(false)}
                }}
              />
        ...
        <div>
          <div className="summary-section">
            ...
            <div>
              ...
              <p className="price-info">Total: ₹{subtotal + deliveryCharge + paymentPlatFormCharge}</p>
            </div>
          </div>
          <button 
